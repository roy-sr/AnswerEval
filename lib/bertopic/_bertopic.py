...
# BERTopic
try:
    from lib.bertopic._ctfidf import ClassTFIDF
    from lib.bertopic._utils import MyLogger, check_documents_type, check_embeddings_shape, check_is_fitted
    from lib.bertopic._mmr import mmr
    from lib.bertopic.backend._utils import select_backend
    from lib.bertopic import plotting
...
class BERTopic:
    ...
    def get_topic_freq(self, topic: int = None):
    ...
    def get_representative_docs(self, topic: int = None):
    ...
    def _map_predictions(self, predictions: List[int]):
    ...
    def _reduce_dimensionality(self,
        ...
        # umap_embeddings = self.pca_model.transform(embeddings)
        # logger.info("Reduced dimensionality with PCA")
    ...
    def _reduce_topics(self, documents: pd.DataFrame):
    ...
    def _reduce_to_n_topics(self, documents: pd.DataFrame):
    ...
    def _auto_reduce_topics(self, documents: pd.DataFrame):
    ...
    def _sort_mappings_by_frequency(self, documents: pd.DataFrame):
    ...
    def _preprocess_text(self, documents: np.ndarray):
    ...
    @staticmethod
    def _top_n_idx_sparse(matrix: csr_matrix, n: int):
    ...
    @staticmethod
    def _top_n_values_sparse(matrix: csr_matrix, indices: np.ndarray):
